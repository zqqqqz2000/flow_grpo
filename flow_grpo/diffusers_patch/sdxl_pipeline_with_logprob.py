...
# - It uses a standard DDIM scheduler with logprob support instead of the SD3 flow scheduler
...
from .sdxl_ddim_with_logprob import ddim_step_with_logprob
...
def pipeline_with_logprob(
    ...
    # 6. Prepare extra step kwargs. TODO: Logic should ideally be moved out of the pipeline
