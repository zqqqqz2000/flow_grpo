...
class VQAScorer:
    ...
    def calc_score(self, vqa_pipeline: Pipeline, images: torch.Tensor, metadata: tuple[Any]):
...
def vqa_reward(vqa_model: str, sample_batch_size: int):
    reward_fn = VQAScorer()
    ...
    return partial(reward_fn.calc_score, vqa_pipeline)
